...
function useMagneticEffect(ref: React.RefObject<HTMLElement | null>, strength: number = 0.3) {
  ...
  return (
    <section className="section-pinned relative flex items-center justify-center">
      ...
      <motion.div 
        ...
        style={{ x: springX, y: springY, scale: imageScale, opacity: imageOpacity }}
      >
        <img 
      ...
      <div className="relative z-10 w-full max-w-[1800px] mx-auto px-6 lg:px-12">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            >
              Architecting the Future of Industrial Recycling and Sustainable Mobility.
            </motion.p>
          </motion.div>
          ...
          >
            ...
            <div className="space-y-4">
              {['Recycling & Trading', 'EV Dealership Network', 'East Champaran, Bihar'].map((item, i) => (
                <motion.div 
                  key={item}
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <motion.p 
              ...
              transition={{ duration: 0.8, delay: 0.5 }}
            >
              HRK Enterprises functions as a high-integrity node in the recycling ecosystem. 
              We manage complex scrap logistics with absolute transparency, ethical conduct, 
              and verified documentation. From East Champaran, Bihar, we provide the 'Proof of Trust' 
              required for modern industrial sustainability.
            </motion.p>
            ...
            >
              {values.map((item, i) => (
                ...
                >
                  ...
                  <span className="text-hrk-white text-sm font-medium">{item.label}</span>
                </motion.div>
              ))}
            </motion.div>
          </motion.div>
          ...
          >
            ...
            <div className="space-y-4">
              {['Scrap Metal Sourcing', 'Verified Weighbridge', 'Documentation & Compliance'].map((item, i) => (
                <motion.div 
                  key={item}
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <motion.p 
              ...
              transition={{ duration: 0.8, delay: 0.5 }}
            >
              Accelerating the shift to a green mainnet. HRK Merchants & Co. specializes in 
              the high-liquidity trading of EV mobility solutions. We combine strategic market 
              insight with a robust dealer network to ensure every vehicle transaction is seamless, 
            ...
            >
              {[
                ...
                <motion.div 
                  ...
                  animate={isInView ? { opacity: 1, y: 0 } : {}}
                  transition={{ duration: 0.6, delay: 0.7 + i * 0.1 }}
                  whileHover={{ scale: 1.05, backgroundColor: 'rgba(46, 107, 255, 0.1)' }}
                >
              ...
              {specs.map((spec, i) => (
                ...
                >
                  ...
                  <div className="text-right">
                    <span className="text-hrk-blue font-display font-bold text-lg">{spec.value}</span>
                    <span className="text-hrk-gray text-xs ml-1">{spec.unit}</span>
                  </div>
                </motion.div>
              ))}
            </div>
...
function QuoteSection() {
  ...
  const quote = "I believe in building my own legacy through hard work, trust, and transparent business dealings. At HRK Enterprises, our goal is not just profit, but long-term relationships and sustainable growth.";
      ...
      <div className="relative z-10 w-full max-w-[1800px] mx-auto px-6 lg:px-12">
        ...
        >
          ...
          >
            ...
            <div>
              <p className="text-hrk-white font-display font-semibold">Aditya Kumar Giri</p>
              <p className="text-hrk-gray text-sm">Founder & Director, HRK Groups</p>
            </div>
          </motion.div>
        </motion.div>
      </div>
...
function ContactSection() {
  ...
  const address = "Ground Floor, HRK Commercial Complex, Near Main Market, Paharpur, East Champaran, Bihar – 845458";
  ...
  const stats = [
    ...
    { value: '1200+', label: 'EV Customers' },
    { value: '24h', label: 'Documentation Turnaround' },
  ];
  
  return (
    <section ref={sectionRef} className="relative min-h-screen flex flex-col justify-center py-20">
      {/* Background */}
        ...
        >
          ...
          <div className="glass-panel-sm p-6">
            <div className="flex items-center gap-3 mb-4">
              ...
              <span className="font-mono text-xs tracking-[0.12em] text-hrk-gray uppercase">Address</span>
            </div>
          ...
          <div className="glass-panel-sm p-6">
            <div className="flex items-center gap-3 mb-4">
              ...
              <span className="font-mono text-xs tracking-[0.12em] text-hrk-gray uppercase">Phone</span>
            </div>
            <p className="text-hrk-white text-lg font-display">+91 98765 43210</p>
          </div>
          ...
          <div className="glass-panel-sm p-6">
            <div className="flex items-center gap-3 mb-4">
              ...
              <span className="font-mono text-xs tracking-[0.12em] text-hrk-gray uppercase">Email</span>
            </div>
            <p className="text-hrk-white text-lg font-display">connect@hrkgroups.in</p>
          </div>
          ...
          <div className="glass-panel-sm p-6">
            <div className="flex items-center gap-3 mb-4">
              ...
              <span className="font-mono text-xs tracking-[0.12em] text-hrk-gray uppercase">Hours</span>
            </div>
